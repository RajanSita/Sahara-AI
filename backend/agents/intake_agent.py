...
def run(form_data: IntakeFormRequest) -> dict:
    ...
    case_data = {
        ...
        "death_certificate_file": getattr(form_data, "death_certificate_file", None),
        "hospital_summary_file": getattr(form_data, "hospital_summary_file", None) or getattr(form_data, "supporting_document_file", None),
